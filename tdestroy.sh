...
# → tfstate / static / product-images / uploads Bucket 은 그대로 유지된다.
...
echo "[tdestroy] 보존 대상        : S3 (tfstate/static/product-images/uploads)"
...
echo "[tdestroy] S3 Bucket 4개는 삭제 대상에서 제외했습니다."
